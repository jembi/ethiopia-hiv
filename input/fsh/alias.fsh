...
Alias: $CarePlan = http://moh.gov.et/fhir/hiv/CodeSystem/care-plan-category-code-system
...
Alias: $PS-FPM-YesNoCodeSystem = http://moh.gov.et/fhir/hiv/CodeSystem/ps-fpm-yes-no-code-system
Alias: $Screened-For-TB-YesNoCodeSystem = http://moh.gov.et/fhir/hiv/CodeSystem/screened-for-tb-yes-no-code-system
Alias: $Therapeutic-Supplementary-Food-YesNoCodeSystem = http://moh.gov.et/fhir/hiv/CodeSystem/therapeutic-supplementary-food-yes-no-code-system
Alias: $CCS-Counselling-YesNoCodeSystem = http://moh.gov.et/fhir/hiv/CodeSystem/ccs-counselling-yes-no-code-system
Alias: $CCS-Accepted-YesNoCodeSystem = http://moh.gov.et/fhir/hiv/CodeSystem/ccs-accepted-yes-no-code-system
Alias: $Resides-Within-Catchment-Area-YesNoCodeSystem = http://moh.gov.et/fhir/hiv/CodeSystem/resides-within-catchment-area-yes-no-code-system
Alias: $FollowUp-Challenges-Anticipated-YesNoCodeSystem = http://moh.gov.et/fhir/hiv/CodeSystem/followUp-challenges-anticipated-yes-no-code-system
Alias: $HIV-Status-Disclosure-At-Enrollment-YesNoCodeSystem = http://moh.gov.et/fhir/hiv/CodeSystem/hiv-status-disclosure-at-enrollment-yes-no-code-system
Alias: $Tested-For-HIV-YesNoCodeSystem = http://moh.gov.et/fhir/hiv/CodeSystem/tested-for-hiv-yes-no-code-system
Alias: $Counseled-For-HIV-YesNoCodeSystem = http://moh.gov.et/fhir/hiv/CodeSystem/counseled-for-hiv-yes-no-code-system
Alias: $Viral-Load-Performed-YesNoCodeSystem = http://moh.gov.et/fhir/hiv/CodeSystem/viral-load-performed-yes-no-code-system
Alias: $Cotrimoxazole-Preventive-Therapy-Started-YesNoCodeSystem = http://moh.gov.et/fhir/hiv/CodeSystem/cotrimoxazole-preventive-therapy-started-yes-no-code-system
Alias: $Fluconazole-Preventive-Therapy-Started-YesNoCodeSystem = http://moh.gov.et/fhir/hiv/CodeSystem/fluconazole-preventive-therapy-started-yes-no-code-system
Alias: $HIV-Program-Final-Outcome-Known-YesNoCodeSystem = http://moh.gov.et/fhir/hiv/CodeSystem/hiv-program-final-outcome-known-yes-no-code-system
Alias: $TB-Treatment-Started-YesNoCodeSystem = http://moh.gov.et/fhir/hiv/CodeSystem/tb-treatment-started-yes-no-code-system
Alias: $Assessed-For-Pain-YesNoCodeSystem = http://moh.gov.et/fhir/hiv/CodeSystem/assessed-for-pain-yes-no-code-system
Alias: $Level-Of-Pain-YesNoCodeSystem = http://moh.gov.et/fhir/hiv/CodeSystem/level-of-pain-yes-no-code-system
Alias: $Enrolled-Operation-Tripple-Zero-YesNoCodeSystem = http://moh.gov.et/fhir/hiv/CodeSystem/enrolled-operation-tripple-zero-yes-no-code-system
Alias: $HIV-Treatment-Prior-To-Enrollment-YesNoCodeSystem = http://moh.gov.et/fhir/hiv/CodeSystem/hiv-treatment-prior-to-enrollment-yes-no-code-system
Alias: $Index-Case-Screening-YesNoCodeSystem = http://moh.gov.et/fhir/hiv/CodeSystem/index-case-screening-yes-no-code-system
Alias: $Index-Case-Assessment-YesNoCodeSystem = http://moh.gov.et/fhir/hiv/CodeSystem/index-case-assessment-yes-no-code-system
Alias: $Family-Index-Case-Contacts-YesNoCodeSystem = http://moh.gov.et/fhir/hiv/CodeSystem/family-index-case-contacts-yes-no-code-system
Alias: $Index-Case-Sex-Partner-YesNoCodeSystem = http://moh.gov.et/fhir/hiv/CodeSystem/index-case-sex-partner-yes-no-code-system