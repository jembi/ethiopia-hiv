...
Alias: $YesNoBreastFeedingCodeSystem = http://moh.gov.et/fhir/hiv/CodeSystem/yes-no-code-system
Alias: $YesNoFuturePregnancyCodeSystem = http://moh.gov.et/fhir/hiv/CodeSystem/yes-no-code-system
Alias: $YesNoPregnancyStatusCodeSystem = http://moh.gov.et/fhir/hiv/CodeSystem/yes-no-code-system
